...
- Crisp edges toggle: nearest-neighbor resize plus sharper corner tracing for hard-edged sources; auto-enabled by detection, available manually for any image.
